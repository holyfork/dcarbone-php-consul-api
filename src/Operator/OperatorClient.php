...
{
    public function AreaCreate(Area $area, WriteOptions|null $opts = null): ValuedWriteStringResponse
    {
        return $this->_writeIDResponse($this->_requireOK($this->_doPost('v1/operator/area', $area, $opts)));
    }

    public function AreaUpdate(string $areaID, Area $area, WriteOptions|null $opts = null): ValuedWriteStringResponse
    {
    ...
    public function AreaGet(string $areaID, QueryOptions|null $opts = null): OperatorAreasResponse
    {
    ...
    public function AreaList(QueryOptions|null $opts = null): OperatorAreasResponse
    {
    ...
    public function AreaDelete(string $areaID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('v1/operator/area/%s', $areaID), $opts);
    }

    public function AreaJoin(string $areaID, array $addresses, WriteOptions|null $opts = null): OperatorAreaJoinResponse
    {
    ...
    public function AreaMembers(string $areaID, QueryOptions|null $opts = null): OperatorSerfMembersResponse
    {
    ...
    public function AutopilotGetConfiguration(QueryOptions|null $opts = null): OperatorAutopilotConfigurationResponse
    {
    ...
    public function AutopilotSetConfiguration(AutopilotConfiguration $conf, WriteOptions|null $opts = null): Error|null
    {
    ...
    public function AutopilotServerHealth(QueryOptions|null $opts = null): OperatorHealthReplyResponse
    {
    ...
    public function AutopilotState(QueryOptions|null $opts = null): AutopilotStateResponse
    {
    ...
    public function RaftGetConfiguration(QueryOptions|null $opts = null): OperatorRaftConfigurationResponse
    {
    ...
    public function RaftRemovePeerByAddress(string $address, WriteOptions|null $opts = null): Error|null
    {
