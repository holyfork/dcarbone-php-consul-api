...
{
    public function Register(CatalogRegistration $catalogRegistration, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executePut('v1/catalog/register', $catalogRegistration, $opts);
    }

    public function Deregister(CatalogDeregistration $catalogDeregistration, WriteOptions|null $opts = null): WriteResponse
    {
    ...
    public function Nodes(QueryOptions|null $opts = null): NodesResponse
    {
    ...
    public function Services(QueryOptions|null $opts = null): ValuedQueryStringsResponse
    {
    ...
    public function NodeServicesList(string $node, QueryOptions|null $opts = null): CatalogNodeServicesListResponse
    {
    ...
    public function Service(string $service, string $tag = '', QueryOptions|null $opts = null): CatalogServicesResponse
    {
        return $this->ServiceMultipleTags($service, '' !== $tag ? [$tag] : [], $opts);
    }

    public function Node(string $node, QueryOptions|null $opts = null): CatalogNodeResponse
    {
    ...
    public function GatewayServices(string $gateway, QueryOptions|null $opts = null): GatewayServicesResponse
    {
