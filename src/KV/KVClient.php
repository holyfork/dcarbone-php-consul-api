...
{
    public function Get(string $key, QueryOptions|null $opts = null): KVPairResponse
    {
    ...
    public function Put(KVPair $p, WriteOptions|null $opts = null): WriteResponse
    {
    ...
    public function Delete(string $key, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('v1/kv/%s', $key), $opts);
    }

    public function List(string $prefix = '', QueryOptions|null $opts = null): KVPairsResponse
    {
    ...
    public function Keys(string $prefix = '', QueryOptions|null $opts = null): ValuedQueryStringsResponse
    {
        $r = $this->_newGetRequest(sprintf('v1/kv/%s', $prefix), $opts);
        $r->params->set('keys', '');
    ...
    public function CAS(KVPair $p, WriteOptions|null $opts = null): ValuedWriteBoolResponse
    {
        $r = $this->_newPutRequest(sprintf('v1/kv/%s', $p->Key), $p->Value, $opts);
    ...
    public function Acquire(KVPair $p, WriteOptions|null $opts = null): WriteResponse
    {
        $r = $this->_newPutRequest(sprintf('v1/kv/%s', $p->Key), $p->Value, $opts);
    ...
    public function DeleteCAS(KVPair $p, WriteOptions|null $opts = null): ValuedWriteBoolResponse
    {
    ...
    public function Release(KVPair $p, WriteOptions|null $opts = null): WriteResponse
    {
        $r = $this->_newPutRequest(sprintf('v1/kv/%s', $p->Key), $p->Value, $opts);
    ...
    public function DeleteTree(string $prefix, WriteOptions|null $opts = null): WriteResponse
    {
    ...
    public function Txn(KVTxnOps $txn, QueryOptions|null $opts = null): KVTxnAPIResponse
    {
        $txnOps = new KVTxnOps();
        foreach ($txn as $op) {
     ...
     * )
     */
    public function Tree(string $prefix = '', QueryOptions|null $opts = null): array
    {
