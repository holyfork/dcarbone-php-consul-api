...
class CoordinateClient extends AbstractClient
{
    ...
    public function Nodes(QueryOptions|null $opts = null): CoordinateEntriesResponse
    {
    ...
    public function Update(CoordinateEntry $coordinateEntry, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executePut('v1/coordinate/update', $coordinateEntry, $opts);
    }

    public function Node(string $node, QueryOptions|null $opts = null): CoordinateEntriesResponse
    {
