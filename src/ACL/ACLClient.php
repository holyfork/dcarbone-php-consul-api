...
class ACLClient extends AbstractClient
{
    ...
    public function Create(ACLEntry $acl, WriteOptions|null $opts = null): ValuedWriteStringResponse
    {
        return $this->_executePutValuedStr('v1/acl/create', $acl, $opts);
    }

    public function Update(ACLEntry $acl, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executePut('v1/acl/update', $acl, $opts);
    }

    public function Destroy(string $id, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executePut(sprintf('v1/acl/destroy/%s', $id), null, $opts);
    }

    public function Clone(string $id, WriteOptions|null $opts = null): ValuedWriteStringResponse
    {
        return $this->_executePutValuedStr(sprintf('v1/acl/clone/%s', $id), null, $opts);
    }

    public function Info(string $id, QueryOptions|null $opts = null): ACLEntriesResponse
    {
    ...
    public function List(QueryOptions|null $opts = null): ACLEntriesResponse
    {
    ...
    public function Replication(QueryOptions|null $opts = null): ACLReplicationStatusResponse
    {
    ...
    public function TokenCreate(ACLToken $token, WriteOptions|null $opts = null): ACLTokenWriteResponse
    {
    ...
    public function TokenUpdate(ACLToken $token, WriteOptions|null $opts = null): ACLTokenWriteResponse
    {
        $ret = new ACLTokenWriteResponse();
        if ('' === $token->AccessorID) {
    ...
    public function TokenClone(string $tokenID, string $description, WriteOptions|null $opts = null): ACLTokenWriteResponse
    {
        $ret = new ACLTokenWriteResponse();
        if ('' === $tokenID) {
    ...
    public function TokenDelete(string $tokenID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('/v1/acl/token/%s', $tokenID), $opts);
    }

    public function TokenRead(string $tokenID, QueryOptions|null $opts = null): ACLTokenQueryResponse
    {
    ...
    public function TokenReadSelf(QueryOptions|null $opts = null): ACLTokenQueryResponse
    {
    ...
    public function TokenList(QueryOptions|null $opts = null): ACLTokenListEntryQueryResponse
    {
    ...
    public function PolicyCreate(ACLPolicy $policy, WriteOptions|null $opts = null): ACLPolicyWriteResponse
    {
    ...
    public function PolicyUpdate(ACLPolicy $policy, WriteOptions|null $opts = null): ACLPolicyWriteResponse
    {
        $ret = new ACLPolicyWriteResponse();
        if ('' === $policy->ID) {
    ...
    public function PolicyDelete(string $policyID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('/v1/acl/policy/%s', $policyID), $opts);
    }

    public function PolicyRead(string $policyID, QueryOptions|null $opts = null): ACLPolicyQueryResponse
    {
    ...
    public function PolicyReadByName(string $policyName, QueryOptions|null $opts = null): ACLPolicyQueryResponse
    {
    ...
    public function PolicyList(QueryOptions|null $opts = null): ACLPolicyListEntryQueryResponse
    {
    ...
    public function RoleCreate(ACLRole $role, WriteOptions|null $opts = null): ACLRoleWriteResponse
    {
    ...
    public function RoleUpdate(ACLRole $role, WriteOptions|null $opts = null): ACLRoleWriteResponse
    {
        $ret = new ACLRoleWriteResponse();
        if ('' === $role->ID) {
    ...
    public function RoleDelete(string $roleID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('/v1/acl/role/%s', $roleID), $opts);
    }

    public function RoleRead(string $roleID, QueryOptions|null $opts = null): ACLRoleQueryResponse
    {
    ...
    public function RoleReadByName(string $roleName, QueryOptions|null $opts = null): ACLRoleQueryResponse
    {
    ...
    public function RoleList(QueryOptions|null $opts = null): ACLRolesQueryResponse
    {
    ...
    public function AuthMethodCreate(ACLAuthMethod $authMethod, WriteOptions|null $opts = null): ACLAuthMethodWriteResponse
    {
    ...
    public function AuthMethodUpdate(ACLAuthMethod $authMethod, WriteOptions|null $opts = null): ACLAuthMethodWriteResponse
    {
        $ret = new ACLAuthMethodWriteResponse();
        if ('' === $authMethod->ID) {
    ...
    public function AuthMethodDelete(string $authMethodID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('/v1/acl/authMethod/%s', $authMethodID), $opts);
    }

    public function AuthMethodRead(string $authMethodID, QueryOptions|null $opts = null): ACLAuthMethodQueryResponse
    {
    ...
    public function AuthMethodList(QueryOptions|null $opts = null): ACLAuthMethodListEntryQueryResponse
    {
    ...
    public function BindingRuleDelete(string $bindingRuleID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('/v1/acl/binding-rule/%s', $bindingRuleID), $opts);
    }

    public function BindingRuleRead(string $bindingRuleID, QueryOptions|null $opts = null): ACLBindingRuleQueryResponse
    {
    ...
    public function BindingRuleList(QueryOptions|null $opts = null): ACLBindingRulesQueryResponse
    {
    ...
    public function Login(ACLLoginParams $login, WriteOptions|null $opts = null): ACLTokenWriteResponse
    {
    ...
    public function Logout(WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executePost('/v1/acl/logout', null, $opts);
    }

    public function OIDCAuthURL(ACLOIDCAuthURLParams $auth, WriteOptions|null $opts = null): ValuedWriteStringResponse
    {
    ...
    public function OIDCCallback(ACLOIDCCallbackParams $auth, WriteOptions|null $opts = null): ACLTokenWriteResponse
    {
        $ret = new ACLTokenWriteResponse();
        if ('' === $auth->AuthMethod) {
            $ret->Err = new Error('must specify an auth method name');
