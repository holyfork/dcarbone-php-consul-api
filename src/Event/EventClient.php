...
{
    public function Fire(UserEvent $event, WriteOptions|null $opts = null): UserEventResponse
    {
    ...
    public function List(string $name = '', QueryOptions|null $opts = null): UserEventsResponse
    {
