...
class HealthClient extends AbstractClient
{
    ...
    public function Node(string $node, QueryOptions|null $opts = null): HealthChecksResponse
    {
        return $this->_getHealthChecks(sprintf('v1/health/node/%s', $node), $opts);
    }

    public function Checks(string $service, QueryOptions|null $opts = null): HealthChecksResponse
    {
    ...
    public function State(string $state, QueryOptions|null $opts = null): HealthChecksResponse
    {
    ...
    protected function _getHealthChecks(string $path, QueryOptions|null $opts): HealthChecksResponse
    {
