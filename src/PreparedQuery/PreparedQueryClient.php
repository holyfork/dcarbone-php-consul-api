...
{
    public function Create(PreparedQueryDefinition $query, WriteOptions|null $opts = null): ValuedWriteStringResponse
    {
    ...
    public function Update(PreparedQueryDefinition $query, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executePut('v1/query', $query, $opts);
    }

    public function List(QueryOptions|null $opts = null): PreparedQueryDefinitionsResponse
    {
    ...
    public function Get(string $queryID, QueryOptions|null $opts = null): PreparedQueryDefinitionsResponse
    {
    ...
    public function Delete(string $queryID, WriteOptions|null $opts = null): WriteResponse
    {
        return $this->_executeDelete(sprintf('v1/query/%s', $queryID), $opts);
    }

    public function Execute(string $queryIDOrName, QueryOptions|null $opts = null): PreparedQueryExecuteResponseResponse
    {
